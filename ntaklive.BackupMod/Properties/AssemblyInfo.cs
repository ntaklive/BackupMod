...
[assembly: Guid("3C82BC80-616B-4020-9515-C441D409AFCA")]
...
namespace ntaklive.BackupMod
{
    public static class AssemblyInfo
    {
        public static string AssemblyVersion
        {
            get
            {
                var executingAssemblyVersion = Assembly.GetExecutingAssembly().GetName().Version.ToString();
            
                return executingAssemblyVersion.Substring(0, executingAssemblyVersion.Length - 2);
            }
        }
